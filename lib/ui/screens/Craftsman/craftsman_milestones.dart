...
import 'craftman_objectives.dart';

class CraftsmanMilestones extends StatefulWidget {
  Project project;
  CraftsmanMilestones({this.project});
  final _foldingCellKey = new GlobalKey<SimpleFoldingCellState>();
  @override
  State<StatefulWidget> createState() => CraftsmanMilestonesState();
}
...
class CraftsmanMilestonesState extends State<CraftsmanMilestones> {
  @override
                ...
                new InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => CraftsmanObjectives(
