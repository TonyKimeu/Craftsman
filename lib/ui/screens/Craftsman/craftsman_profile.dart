...
class CraftsmanProfile extends StatelessWidget {
  final image = 'assets/images/default.png';
  @override
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  Text("Antony The Craftsman", style: Theme.of(context).textTheme.title,),
                                  ListTile(
                                    contentPadding: EdgeInsets.all(0),
                                    title: Text("Role"),
                                    subtitle: Text("Craftsman"),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        ListTile(
                          title: Text("Email"),
                          subtitle: Text("craftman@email.com"),
