...
import "package:craftsman/models/walkthrough.dart";
class WalkthroughScreen extends StatefulWidget {
  ...
  final List<Walkthrough> pages = [
    Walkthrough(
      ...
      title: "Craftsman",
      description:
      "Lorem ipsum dolor sit amet, eam facilis temporibus ei. Ex omnium adipisci qui. Zril oportere suavitate eu mei. In labitur argumentum pro, est ne probo nominavi consequuntur, velit tacimates est te.",
    ),
    Walkthrough(
